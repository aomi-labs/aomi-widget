...
- `auth` owners: frontend | code globs: packages/auth/**, apps/portal/src/app/api/auth/**, apps/portal/src/lib/aomi-auth/**, apps/registry/src/lib/aomi-auth-adapter/**, packages/react/src/runtime/user-state-provider.tsx | docs globs: docs/topics/auth/facts/auth.md, docs/topics/auth/facts/auth-adapter.md, docs/topics/auth/facts/base-account.md
