...
`docs/` is the maintained knowledge surface for `aomi-widget`. Topic pages capture durable implementation knowledge, while generated inventories support discovery and ownership lookup.
...
- repo-overview: [topics/repo-overview.md](topics/repo-overview.md)
- widget-frame: [topics/widget-frame.md](topics/widget-frame.md)
- runtime-react: [topics/runtime-react.md](topics/runtime-react.md)
- ts-client: [topics/ts-client.md](topics/ts-client.md)
- cli: [topics/cli.md](topics/cli.md)
- auth-adapter: [topics/auth-adapter.md](topics/auth-adapter.md)
- demo-apps: [topics/demo-apps.md](topics/demo-apps.md)

## Policy

- Durable repo knowledge belongs in `docs/topics/`.
