...
| D2  | connected addr A → reconnect addr B (no disconnect between) | address=B, chain*id preserved, wallet_provider/wallet_kind/auth_method/sponsored preserved, BUT aa_mode/smart_account_4337/delegation_7702/ens_name/pending*\*=undefined                |
