...
export const registry: RegistryComponent[] = [
  ...
  },
  {
    ...
    file: [
      ...
      "lib/aomi-auth-adapter/solana-networks.ts",
  ...
  },
  {
    ...
    file: [
      ...
      "lib/aomi-auth-adapter/providers/para/use-wallet-registry.ts",
      "lib/aomi-auth-adapter/providers/para/sources/wagmi-source.ts",
      "lib/aomi-auth-adapter/providers/para/sources/para-session-source.ts",
      "lib/aomi-auth-adapter/providers/para/sources/solana-source.ts",
