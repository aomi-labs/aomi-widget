...
export const registry: RegistryComponent[] = [
  ...
  },
  {
    ...
    file: [
      ...
      "lib/aomi-auth-adapter/accounts.ts",
      "lib/aomi-auth-adapter/aa/owner.ts",
      "lib/aomi-auth-adapter/catalog/evm-connector-catalog.ts",
      "lib/aomi-auth-adapter/catalog/svm-wallet-catalog.ts",
      "lib/aomi-auth-adapter/catalog/wallet-ids.ts",
      "lib/aomi-auth-adapter/config/AomiWalletKitProvider.tsx",
      ...
      "lib/aomi-auth-adapter/account/types.ts",
      "lib/aomi-auth-adapter/account/disabled-runtime.ts",
      "lib/aomi-auth-adapter/composer/AomiAdapterComposer.tsx",
      "lib/aomi-auth-adapter/composer/build-accounts.ts",
      "lib/aomi-auth-adapter/composer/build-identity.ts",
      "lib/aomi-auth-adapter/composer/build-methods.ts",
      "lib/aomi-auth-adapter/composer/merge-wallet-rows.ts",
      "lib/aomi-auth-adapter/composer/types.ts",
      "lib/aomi-auth-adapter/runtime/evm/brands.ts",
      "lib/aomi-auth-adapter/runtime/evm/identity-grace.ts",
      "lib/aomi-auth-adapter/runtime/svm/networks.ts",
      "lib/aomi-auth-adapter/runtime/svm/transactions.ts",
      "lib/aomi-auth-adapter/runtime/svm/wallet-runtime.ts",
      "lib/aomi-auth-adapter/registry/types.ts",
      "lib/aomi-auth-adapter/registry/reducer.ts",
      "lib/aomi-auth-adapter/registry/policy.ts",
      "lib/aomi-auth-adapter/registry/commands.ts",
      "lib/aomi-auth-adapter/registry/persistence.ts",
      "lib/aomi-auth-adapter/registry/store.ts",
      "lib/aomi-auth-adapter/registry/selectors.ts",
  ...
  },
  {
    ...
    file: [
      ...
      "lib/aomi-auth-adapter/providers/para/ParaPluginProvider.tsx",
      "lib/aomi-auth-adapter/providers/para/para-auth.ts",
      "lib/aomi-auth-adapter/providers/para/para-embedded-wallet.ts",
      "lib/aomi-auth-adapter/providers/para/para-evm-runtime.tsx",
      "lib/aomi-auth-adapter/providers/para/para-svm.tsx",
      "lib/aomi-auth-adapter/providers/para/para-aa.ts",
      "lib/aomi-auth-adapter/registry/use-wallet-registry.ts",
      "lib/aomi-auth-adapter/runtime/evm/registry-source.ts",
      "lib/aomi-auth-adapter/runtime/evm/provider.tsx",
      "lib/aomi-auth-adapter/runtime/evm/wallet-runtime.ts",
      "lib/aomi-auth-adapter/providers/para/sources/para-session-source.ts",
      "lib/aomi-auth-adapter/runtime/svm/registry-source.ts",
      "lib/aomi-auth-adapter/runtime/evm/disconnect-plan.ts",
      "lib/aomi-auth-adapter/runtime/evm/identity-grace.ts",
      "lib/aomi-auth-adapter/full-testnet-wallet-routing.tsx",
      "lib/aomi-auth-adapter/network-preferences.tsx",
      "lib/aomi-auth-adapter/runtime/evm/safe-hooks.ts",
      "lib/aomi-auth-adapter/runtime/evm/brands.ts",
      "lib/aomi-auth-adapter/catalog/evm-connector-catalog.ts",
      "lib/aomi-auth-adapter/catalog/wallet-ids.ts",
      "lib/aomi-auth-adapter/runtime/svm/networks.ts",
