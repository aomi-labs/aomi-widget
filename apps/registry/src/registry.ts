...
export const registry: RegistryComponent[] = [
  ...
  },
  {
    ...
    file: [
      ...
      "lib/aomi-auth-adapter/runtime/solana/networks.ts",
      "lib/aomi-auth-adapter/runtime/solana/transactions.ts",
      "lib/aomi-auth-adapter/runtime/solana/wallet-runtime.ts",
  ...
  },
  {
    ...
    file: [
      ...
      "lib/aomi-auth-adapter/runtime/solana/registry-source.ts",
