...
export const registry: RegistryComponent[] = [
  ...
  },
  {
    ...
    file: [
      ...
      "lib/wallet-kit/composer/build-accounts.ts",
      ...
      "lib/wallet-kit/runtime/evm/identity-grace.ts",
      "lib/wallet-kit/runtime/svm/networks.ts",
  ...
  },
  {
    ...
    file: [
      ...
      "lib/wallet-kit/providers/para/para-evm-runtime.tsx",
      "lib/wallet-kit/providers/para/para-svm.tsx",
      "lib/wallet-kit/providers/para/para-aa.ts",
  ...
  },
  {
    ...
    file: [
      "lib/wallet-kit/providers/base-account/index.ts",
      "lib/wallet-kit/providers/base-account/base-account.tsx",
      "lib/wallet-kit/catalog/evm-connector-catalog.ts",
      "lib/wallet-kit/catalog/wallet-ids.ts",
      "lib/wallet-kit/runtime/evm/safe-hooks.ts",
      "lib/wallet-kit/wallet-execution.ts",
    ...
    registryDependencies: [aomi("aomi-wallet-kit")],
    description:
      "Base Account-backed Aomi wallet kit provider using wagmi native wallet execution.",
  },
  {
