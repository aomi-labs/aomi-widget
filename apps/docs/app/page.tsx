...
const installSnippet = `pnpm add @aomi-labs/react @aomi-labs/registry @assistant-ui/react @assistant-ui/react-markdown @tanstack/react-query @radix-ui/react-dialog @radix-ui/react-slot @radix-ui/react-avatar @radix-ui/react-separator @radix-ui/react-tooltip framer-motion motion lucide-react react-shiki remark-gfm tailwindcss zustand`;
...
const buttonsCode = `import { Button, Badge } from "@aomi-labs/registry";
...
const cardCode = `import { Card, CardContent, CardHeader, CardTitle, Skeleton } from "@aomi-labs/registry";
