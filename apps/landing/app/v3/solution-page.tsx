...
const productHref = (href: string) => {
  ...
  return translated ? `${V3}/products/${translated}` : `${V3}/products`;
};
    ...
    <main className={styles.solutionPage}>
      <section className={styles.solutionHero}>
        ...
        <div className={styles.solutionHeroCopy}>
          ...
          <div className={styles.detailHeroActions}>
            ...
            <Link href={`${V3}/products/rest-apis`}>Explore the APIs</Link>
          </div>
        </div>
      ...
      <section className={styles.solutionCta}>
        ...
        <div>
          ...
          <Link href={`${V3}/products/rest-apis`}>Read the API overview</Link>
        </div>
      </section>
    </main>
  );
