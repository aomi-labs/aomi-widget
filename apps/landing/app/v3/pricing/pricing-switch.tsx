  ...
  user: [
    {
      ...
      cta: { label: "Open Aomi", href: "https://chat.aomi.dev", external: true },
    },
    {
      label: "Pay as you go",
      price: "$0.01",
  ...
  enterprise: [
    {
      ...
      cta: { label: "Start building", href: "https://build.aomi.dev", external: true },
    },
    {
      label: "Model usage",
      price: "+10%",
    ...
    },
    {
      ...
      cta: { label: "Talk to us", href: `${V3}/contact` },
    },
  ],
};
      ...
      <div className={styles.switchRow}>
        <div className={styles.switch} role="tablist" aria-label="Audience">
          {(["user", "enterprise"] as const).map((id) => (
            ...
            >
              {id === "user" ? "For retail users" : "For enterprise & developers"}
            </button>
          ))}
        </div>
