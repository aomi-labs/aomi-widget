  ...
  return (
    <header ref={rootRef} className={styles.navDock}>
      <nav className={styles.navPill} aria-label="Primary">
        <Link href={V3} className={styles.navBrand} aria-label="Aomi V3 home">
          <AomiLogo
        ...
        <div className={styles.navDesktop}>
          ...
          <Link href={`${V3}/pricing`} className={styles.navTextLink}>
            Pricing
          </Link>
        </div>
      ...
      {mobileOpen ? (
        <div className={styles.navMobilePanel}>
          <div className={styles.navMobileScroll}>
            ...
            <Link href={`${V3}/pricing`} className={styles.navMobilePricing}>
              Pricing
            </Link>
