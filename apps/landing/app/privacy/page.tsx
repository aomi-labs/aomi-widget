          ...
          <div className="overflow-hidden rounded-[2rem] bg-stone-100/95 p-8 ring-1 ring-stone-200 backdrop-blur-xl md:p-12">
            <div className="max-w-none">
              ...
              <section className="mb-8">
                ...
                <h3 className="mb-2 font-geist text-lg font-medium text-stone-800">
              ...
              <section className="mb-8">
                ...
                <ul className="mb-2 list-disc space-y-1 pl-6 font-geist text-base text-stone-600">
                  <li><strong className="text-stone-800">Service Providers:</strong> Third parties who assist in operating our services (hosting, analytics, support)</li>
                  <li><strong className="text-stone-800">Blockchain Networks:</strong> Transaction data is broadcast to public blockchain networks as required</li>
                  <li><strong className="text-stone-800">Legal Requirements:</strong> When required by law or to protect our rights</li>
                  <li><strong className="text-stone-800">Business Transfers:</strong> In connection with a merger, acquisition, or sale of assets</li>
                </ul>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="font-geist text-base leading-relaxed text-stone-600">
                  ...
                  <a href="mailto:privacy@aomi.dev" className="text-stone-800 underline hover:text-stone-600">
                    privacy@aomi.dev
                  </a>
                </p>
              </section>
