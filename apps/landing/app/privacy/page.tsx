            ...
            <div className="max-w-none">
              <section className="mb-8">
                ...
                <p className="font-geist mb-2 text-base leading-relaxed text-stone-600">
                  Aomi Labs (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;)
                  is committed to protecting your privacy. This Privacy Policy
                  explains how we collect, use, disclose, and safeguard your
                  information when you use our blockchain AI infrastructure
                  services, including our widget, API, and related tools.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <h3 className="font-geist mb-2 text-lg font-medium text-stone-800">
                  2.1 Information You Provide
                </h3>
                <ul className="font-geist mb-2 list-disc space-y-1 pl-6 text-base text-stone-600">
                  <li>
                    Account information (email address, organization name)
                  </li>
                ...
                <p className="font-geist mb-2 text-base leading-relaxed text-stone-600">
                  ...
                  services. Wallet addresses and transaction data are used
                  solely to execute your requested operations and are not stored
                  longer than necessary for service delivery.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <ul className="font-geist mb-2 list-disc space-y-1 pl-6 text-base text-stone-600">
                  <li>
                    ...
                    Third parties who assist in operating our services (hosting,
                    analytics, support)
                  </li>
                  <li>
                    <strong className="text-stone-800">
                    ...
                    Transaction data is broadcast to public blockchain networks
                    as required
                  </li>
                  <li>
                    <strong className="text-stone-800">
              ...
              <section className="mb-8">
                ...
                <p className="font-geist mb-2 text-base leading-relaxed text-stone-600">
                  ...
                  Account data is retained until you request deletion. Some data
                  may be retained longer for legal or legitimate business
                  purposes.
                </p>
              </section>
