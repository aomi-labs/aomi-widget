      ...
      <main className="relative z-10 flex min-h-screen w-full flex-col items-center justify-center px-4 pt-24 pb-16">
        <div className="mx-auto w-full max-w-2xl">
          ...
          <div className="mb-12 text-center">
            <h1 className="font-geist mb-4 text-4xl font-bold tracking-tight text-white md:text-5xl">
              Get in Touch
            </h1>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <a
              ...
              className="group flex flex-col gap-4 rounded-2xl bg-black/20 p-6 ring-1 ring-white/10 backdrop-blur-xl transition-all hover:bg-black/30 hover:ring-white/20"
            >
            ...
            <a
              ...
              className="group flex flex-col gap-4 rounded-2xl bg-black/20 p-6 ring-1 ring-white/10 backdrop-blur-xl transition-all hover:bg-black/30 hover:ring-white/20"
            >
              <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-pink-500/20 ring-1 ring-pink-500/30">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
            ...
            <a
              ...
              className="group flex flex-col gap-4 rounded-2xl bg-black/20 p-6 ring-1 ring-white/10 backdrop-blur-xl transition-all hover:bg-black/30 hover:ring-white/20"
            >
              <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-stone-500/20 ring-1 ring-stone-500/30">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
          ...
          <div className="mt-12 text-center">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="group font-geist relative inline-flex items-center gap-2 overflow-hidden rounded-full bg-gradient-to-r from-purple-500 to-pink-500 px-8 py-3 text-sm font-semibold text-white shadow-[0_0_20px_rgba(168,85,247,0.4)] transition-all hover:shadow-[0_0_30px_rgba(168,85,247,0.6)] active:scale-95"
            >
              Book a Call
              <svg
                xmlns="http://www.w3.org/2000/svg"
