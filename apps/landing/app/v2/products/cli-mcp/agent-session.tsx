...
export const SESSIONS: readonly Session[] = [
  {
    ...
    lines: [
      ...
      { kind: "out", text: "queued  tx-1 approve USDC   tx-2 supply Morpho Blue" },
  ...
  },
  {
    ...
    lines: [
      ...
      { kind: "out", text: "tx-1  approve USDC      pending   base", delay: 500 },
      { kind: "out", text: "tx-2  supply Morpho     pending   base", delay: 120 },
      { kind: "cmd", text: "aomi tx simulate tx-1 tx-2", delay: 500 },
      { kind: "ok", text: "fork ok · gas 0.0007 ETH · batch_status ready", delay: 1000 },
