...
See [Theming](/docs/build-with-aomi/integration/widget/theming) for styling customizations and [Configuration](/docs/build-with-aomi/integration/widget/configuration) for runtime options.
