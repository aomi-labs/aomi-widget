...
description: Business and engineering overview for deploying and integrating Aomi into your product.
---
...
- [Builder Quickstart](/docs/build-with-aomi/quickstart) -- get a working widget in 5 minutes.
- [Integration Overview](/docs/build-with-aomi/integration/overview) -- choose widget vs headless implementation.
