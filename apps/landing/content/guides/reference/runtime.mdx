...
This section covers the internal runtime architecture. Most integrators don't need this — see [Core Concepts](/docs/core-concepts/how-it-works) for the client-facing overview.
