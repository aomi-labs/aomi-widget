...
This section covers the internal runtime architecture. Most integrators don't need this — see [How It Works](/docs/build/how-it-works) for the client-facing overview.
