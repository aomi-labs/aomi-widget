---
title: Simulation
description: How Aomi simulates transactions before signing — the Anvil fork pipeline, snapshot management, and wallet approval flow.
---
...
- [Non-Custodial Automation](/docs/non-custodial-wallet) — user-facing explanation of why simulation matters
- [Wallet Integration](/docs/build/services/wallet-integration) — how to wire up wallet signing in your integration
