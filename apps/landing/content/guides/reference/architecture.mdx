---
title: Architecture
description: Internal architecture reference for how the widget, backend, and wallets fit together.
---
...
graph TB
    ...
    subgraph "API Layer"
        ...
        SSE[SSE Stream<br/>/api/thread/updates]
    end
...
let app = ChatAppBuilder::new(&preamble).await?
    ...
    .build(system_events, sender).await?;
```
