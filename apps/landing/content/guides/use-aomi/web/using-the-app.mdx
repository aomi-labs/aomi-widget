...
- An indicator appears showing what's in progress (e.g., _Fetching token price..._ or _Checking swap routes..._)
...
<div className="rounded-lg border bg-card p-4">
  <div className="mb-3 flex items-center gap-2">
    ...
    <span className="font-medium">
      Used tool: <strong>Fetch Lido stETH implementation contract ABI</strong>
    </span>
  </div>
...
<div className="my-6 rounded-lg border bg-card p-4">
  <div className="flex flex-wrap items-center gap-4">
    ...
    <div className="flex items-center gap-2 rounded-md bg-primary px-3 py-1.5 text-sm text-primary-foreground">
      <svg
        className="size-4"
        fill="none"
        stroke="currentColor"
