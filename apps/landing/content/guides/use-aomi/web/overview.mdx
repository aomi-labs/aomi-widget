...
The agent **streams responses in real time**. When it needs to look something up or take an action, it calls a tool — a direct connection to one of the product's APIs. You'll see a brief inline indicator (e.g., _Fetching ETH price..._ or _Checking balance..._) before the result appears.
