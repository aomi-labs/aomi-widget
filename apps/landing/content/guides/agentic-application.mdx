...
<iframe width="100%" style={{aspectRatio: "16/9"}} src="https://www.youtube.com/embed/TSXkgjIfuKk" title="Aomi App Selector" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
...
- [App Backend Reference](/docs/build/services/app-backend-reference) — registering tools, preambles, and model config
