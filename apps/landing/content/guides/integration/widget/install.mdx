...
- [AomiFrame](/docs/guides/integration/widget/aomi-frame) -- Learn the main component API
- [Component Catalog](/docs/guides/integration/widget/components) -- Browse all available components
- [Theming](/docs/guides/integration/widget/theming) -- Customize colors and styling
- [Configuration](/docs/guides/integration/widget/configuration) -- Environment variables and runtime options
