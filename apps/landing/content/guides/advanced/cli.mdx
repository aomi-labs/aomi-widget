...
aomi account whoami
aomi account links
aomi account link --wallet --private-key 0x... --chain 8453 --label "Base wallet"
aomi account link --provider privy
aomi account link --provider para
aomi account rename identity:<id> --label "Work login"
aomi account unlink wallet:<id> --yes
...
flowchart TD
    ...
    MODE -->|"account"| ACCOUNT["aomi account links/link/unlink"]
