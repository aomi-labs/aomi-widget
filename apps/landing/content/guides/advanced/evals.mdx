...
The evaluation framework lets you test AI assistant behavior with automated assertions. Use it to validate tool calling, transaction flows, and response quality.
...
flowchart TB
    subgraph "EvaluationApp"
        AGENT[Headless Agent<br/>No docs]
