...
Script generation automates Foundry/Forge script creation from natural language. The ForgeExecutor orchestrates compilation, dependency resolution, and execution.
