...
- [Namespace](/docs/namespace) -- how API keys, namespaces, and sessions fit together.
- [API Reference](/docs/build/api-reference) -- full HTTP endpoint documentation.
- [Sessions](/docs/build/sessions) -- how chat sessions are created and managed.
