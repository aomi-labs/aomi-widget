...
- [AomiFrame](/docs/build/widget/aomi-frame) -- Learn the main component API.
- [Component Catalog](/docs/build/widget/components) -- Browse all available components.
- [Theming](/docs/build/widget/theming) -- Customize colors and styling.
- [Configuration](/docs/build/widget/configuration) -- Environment variables and runtime options.
- [Namespaces](/docs/build/namespaces) -- Understand how API keys and namespaces work.
- [API Reference](/docs/build/api-reference) -- The full HTTP API for custom integrations.
