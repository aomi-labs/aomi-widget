...
gives you the wallet UI plus the activity sidebar review; you provide the Para and wagmi
...
The widget presents pending wallet requests in its activity sidebar. When a transaction
