...
- [Sessions](/docs/build/services/sessions) -- how sessions and threads are managed.
- [Namespaces and Authentication](/docs/build/namespaces) -- API key scoping and auth flow.
