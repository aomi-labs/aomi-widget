---
title: App Backend Reference
description: How Aomi Apps are structured, configured, and registered on the backend.
---

# App Backend Reference

This reference explains how AI assistants are constructed on the Aomi platform. It covers the AomiApp abstraction, the builder pattern, tool definitions, model selection, and app registration.
