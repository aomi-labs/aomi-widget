...
- [API Reference](/docs/build/api-reference) -- full endpoint documentation for session operations.
- [Namespaces and Authentication](/docs/build/namespaces) -- how sessions relate to namespaces and API keys.
- [Configuration](/docs/build/widget/configuration) -- customize session behavior and thread management in the widget.
