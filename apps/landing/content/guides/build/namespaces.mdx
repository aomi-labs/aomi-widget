...
```bash
curl -X POST https://api.aomi.dev/v1/agent/chat?app=mycoindex \
...
sequenceDiagram
    ...
    Client->>Backend: POST /v1/agent/chat?app=mycoindex<br/>X-API-Key: sk-mcd-...<br/>X-Session-Id: session-uuid
