...
See [Theming](/docs/guides/integration/widget/theming) for styling customizations and [Configuration](/docs/guides/integration/widget/configuration) for runtime options.
