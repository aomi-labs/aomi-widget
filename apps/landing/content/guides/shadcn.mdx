...
Aomi distributes UI components via a **shadcn-compatible registry** at `aomi.dev/r`. This page explains how it works.
...
| Source                 | What                  | Why                                       |
| ---------------------- | --------------------- | ----------------------------------------- |
| **aomi.dev/r**         | Customized components | Aomi-specific features (wallet, branding) |
