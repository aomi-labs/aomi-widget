...
- [API Reference](/docs/core-concepts/api-reference) -- full endpoint documentation for session operations.
- [Namespaces and Authentication](/docs/core-concepts/namespaces) -- how sessions relate to namespaces and API keys.
- [Configuration](/docs/build-with-aomi/integration/widget/configuration) -- customize session behavior and thread management in the widget.
