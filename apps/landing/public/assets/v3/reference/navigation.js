...
function createMobileNavigation(nav, primary, actions) {
  ...
  details.className = "v3-reference-mobile-navigation";

  const toggle = document.createElement("summary");
  toggle.className = "v3-reference-mobile-toggle";
  ...
  menu.id = "v3-reference-mobile-menu";
  menu.className = "v3-reference-mobile-menu";

  for (const sourceMenu of nav.querySelectorAll("[data-v3-menu]")) {
    const group = document.createElement("div");
    group.className = "v3-reference-mobile-menu-group";

    const label = document.createElement("span");
    label.className = "v3-reference-mobile-menu-label";
    label.textContent = sourceMenu.dataset.v3Menu;
    group.append(label);
  ...
  actionRow.className = "v3-reference-mobile-menu-actions";
...
function enhanceNavigation() {
  ...
  createHomeLink(logo);
  primary.classList.add("v3-reference-nav-primary");
  actions.classList.add("v3-reference-nav-actions");
