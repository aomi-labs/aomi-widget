...
var FULL_TESTNET_ENABLED = safeEnv(() => process.env.NEXT_PUBLIC_USE_FULL_TESTNET) === "true";
var FULL_TESTNET_RPC_MAP_RAW = safeEnv(() => process.env.NEXT_PUBLIC_FULL_TESTNET_RPC_MAP)?.trim() ?? "";
...
function DefaultEvmRuntimeProvider({
  ...
  const wagmiConfig = useMemo4(() => createAomiEvmConfig(config), [config]);
  return /* @__PURE__ */ jsx3(AomiEvmRuntimeProvider, { config: wagmiConfig, children });
}
function AomiEvmExternalWalletProvider({
  ...
  const runtimeChildren = /* @__PURE__ */ jsx3(MaybeSvmWalletProvider, { resolvedSvm, children: /* @__PURE__ */ jsx3(
  ...
  const evmRuntime = shouldUseAuthPlugin && authPlugin?.renderEvmRuntimeProvider ? authPlugin.renderEvmRuntimeProvider({
    config: evmConfig,
    children: runtimeChildren
  }) : /* @__PURE__ */ jsx3(DefaultEvmRuntimeProvider, { config: evmConfig, children: runtimeChildren });
...
//# sourceMappingURL=chunk-ZHZS6DK6.js.map