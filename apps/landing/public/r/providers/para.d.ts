...
import { j as SvmNetworkOption, E as ExecutionConfig, i as AccountConfig, f as AuthMethodId, g as AomiWidgetAuthConfig, a as AomiWalletKitProviderInput } from '../types-DhXmbviE.js';
...
declare function paraAuth({ apiKey, environment, methods, appName, appDescription, appUrl, disableWorkers, }: ParaAuthOptions): AomiWidgetAuthConfig;
