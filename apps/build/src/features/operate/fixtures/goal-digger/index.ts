...
export const goalDigger: AppFixture = {
  ...
  detail: {
    ...
    kpis: [
      ...
      { label: "Tool errors", value: "12.0%", tone: "bad", sub: "swap_quote drives it" },
    ...
    chatsHourly: [0, 1, 0, 2, 3, 1, 0, 0, 2, 4, 5, 3, 2, 1, 0, 1, 3, 4, 6, 3, 2, 1, 2, 1],
    toolCallsHourly: [0, 2, 1, 5, 8, 3, 1, 0, 6, 11, 14, 9, 5, 3, 1, 2, 8, 12, 17, 9, 6, 3, 3, 1],
    p95Hourly: [0, 4.1, 0, 5.2, 6.0, 3.8, 0, 0, 5.5, 7.2, 8.4, 6.9, 5.1, 4.2, 0, 3.9, 6.1, 7.8, 8.1, 6.4, 5.0, 4.4, 4.9, 3.7],
    creditsDaily: {
