...
export const geckoterminal: AppFixture = {
  ...
  detail: {
    ...
    chatsHourly: [0, 0, 1, 0, 2, 1, 0, 0, 1, 2, 2, 1, 1, 0, 0, 0, 1, 2, 2, 1, 1, 0, 0, 0],
    toolCallsHourly: [0, 0, 3, 0, 5, 2, 0, 0, 4, 6, 7, 3, 2, 0, 0, 0, 3, 5, 6, 3, 2, 1, 0, 0],
    p95Hourly: [0, 0, 2.1, 0, 2.8, 2.2, 0, 0, 2.5, 3.0, 3.2, 2.6, 2.2, 0, 0, 0, 2.4, 2.9, 3.1, 2.5, 2.3, 2.0, 0, 0],
    creditsDaily: {
      days: ["Jul 9", "Jul 10", "Jul 11", "Jul 12", "Jul 13", "Jul 14", "Jul 15"],
      values: [0.4, 0.55, 0.61, 0.7, 0.66, 0.99, 0.78],
    },
    tools: [
      { tool: "get_price", calls: 21, errors: 0, errorRate: "0%", p95: "310 ms", last: "—" },
      { tool: "get_pool_stats", calls: 17, errors: 0, errorRate: "0%", p95: "520 ms", last: "—" },
      { tool: "get_trending", calls: 14, errors: 1, errorRate: "7.1%", p95: "2900 ms", last: "upstream 429 · 2h ago" },
    ],
    ...
    releases: [
      { tag: "r229e1090c5", when: "Jul 13, 11:02", current: true, note: "SDK 3.0.2" },
      { tag: "r11b7e44d09", when: "Jul 5, 16:40", current: false, note: "SDK 3.0.1" },
    ],
  },
  transactions,
  logs,
