...
export const blogs: BlogEntry[] = [
  {
    ...
    description:
      "Review crypto's failure modes in the context of agents, and how shifting focus to stateless execution puts us on a better track in the technology growth cycle.",
    ...
    imageAlt:
      "Abstract rendering of blockchain nodes connected by light trails",
  ...
  },
  {
    ...
    description:
      "How we evolve toward native execution support in blockchain light clients, optimized with context compilation and type safety in LLM processing.",
    body: "LLM infrastructure demands strong execution guarantees. In this post we break down our compiler-inspired approach to intent capture, the routing mesh that sits between wallet agents and chain simulators, and the instrumentation that keeps the whole pipeline observable.",
