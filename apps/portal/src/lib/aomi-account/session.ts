...
/**
 * The portal's **own** session — a stripped-down, Better-Auth-style session
 * cookie that carries our canonical user id. This is the identity root: it is
 ...
 * arixoneth's Better-Auth session; the cookie name + claim are the seam.
 */
