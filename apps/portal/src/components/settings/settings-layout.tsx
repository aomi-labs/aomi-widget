...
export function SettingsLayout() {
  ...
  // Returning from GitHub flows lands on /settings with query params (category
  // is React state, not the URL), so open the Deploy tab where the launch flow
  // can pick the redirect/session up.
  useEffect(() => {
