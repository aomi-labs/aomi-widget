...
export const blogs: BlogEntry[] = [
    ...
    },
    {
        ...
        description: "How we evolve toward native execution support in blockchain light clients, optimized with context compilation and type safety in LLM processing.",
