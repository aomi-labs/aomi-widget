...
export { API_ENDPOINTS, CSS_CLASSES, ChatManager, DEFAULT_CHAIN_ID, DEFAULT_MAX_HEIGHT, DEFAULT_MESSAGE_LENGTH, DEFAULT_RECONNECT_ATTEMPTS, DEFAULT_RECONNECT_DELAY, DEFAULT_WIDGET_HEIGHT, DEFAULT_WIDGET_WIDTH, ERROR_CODES, AomiChatWidget as ReactAomiWidget, SUPPORTED_CHAINS, TIMING, VERSION, WIDGET_EVENTS, WalletManager, createAomiWidget, createChatWidget, createElement, createWalletManager, createWidgetError, index as default, detectWallets, generateSessionId, isBrowser, isEthereumAddress, isTransactionHash, isValidProvider, resolveWidgetParams, truncateAddress, validateWidgetParams, withTimeout$1 as withTimeout };
