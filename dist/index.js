...
import { createContext as createContext3, useCallback as useCallback2, useContext as useContext3, useState as useState2 } from "react";
  ...
  constructor() {
    ...
    this.promise = (e, t) => {
      ...
      let u = e instanceof Promise ? e : e(), f = a !== void 0, w, S = u.then(async (i) => {
        if (w = ["resolve", i], re.isValidElement(i)) f = false, this.create({ id: a, type: "default", message: i });
        else if (ie(i) && !i.ok) {
          f = false;
...
function NotificationProvider({ children }) {
  ...
  return /* @__PURE__ */ jsxs(
    NotificationContext.Provider,
    {
      ...
      children: [
        children,
        /* @__PURE__ */ jsx3(Toaster, { position: "top-right" })
      ]
    }
  );
}
...
function AomiRuntimeProvider({
  ...
  return /* @__PURE__ */ jsx4(
    RuntimeActionsProvider,
    {
      ...
      children: /* @__PURE__ */ jsx4(AssistantRuntimeProvider, { runtime, children })
    }
  );
}
function AomiRuntimeProviderWithNotifications(props) {
  return /* @__PURE__ */ jsx4(NotificationProvider, { children: /* @__PURE__ */ jsx4(AomiRuntimeProvider, __spreadValues({}, props)) });
}
export {
  AomiRuntimeProvider,
