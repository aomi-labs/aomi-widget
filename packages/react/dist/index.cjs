...
function useRuntimeOrchestrator(aomiClient, options) {
  ...
  const getSession = (0, import_react6.useCallback)(
    (threadId) => {
      ...
      const nextPaymentMethod = (_c = (_b = nextOptions.getPaymentMethod) == null ? void 0 : _b.call(nextOptions)) != null ? _c : null;
...
function AomiRuntimeCore({
  ...
  const getEffectiveApiKey = (0, import_react10.useCallback)(() => {
