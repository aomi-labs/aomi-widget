...
__export(index_exports, {
  ...
  cn: () => cn,
  constructSystemMessage: () => constructSystemMessage,
  constructThreadMessage: () => constructThreadMessage,
...
function ThreadContextProvider({
  ...
  const ensureThreadExists = (0, import_react2.useCallback)(
    (threadId) => {
      setThreadMetadata((prev) => {
  ...
  const [currentThreadId, _setCurrentThreadId] = (0, import_react2.useState)(generateThreadId);
  const [threadViewKey, setThreadViewKey] = (0, import_react2.useState)(0);
  const bumpThreadViewKey = (0, import_react2.useCallback)(() => {
    setThreadViewKey((prev) => prev + 1);
  }, []);
  const setCurrentThreadId = (0, import_react2.useCallback)(
    (threadId) => {
  ...
  const getThreadMessages = (0, import_react2.useCallback)(
    (threadId) => {
      return threads.get(threadId) || [];
    },
    [threads]
  );
  const setThreadMessages = (0, import_react2.useCallback)((threadId, messages) => {
    setThreads((prev) => {
      const next = new Map(prev);
  ...
  const getThreadMetadata = (0, import_react2.useCallback)(
    (threadId) => {
      return threadMetadata.get(threadId);
    },
    [threadMetadata]
  );
  const updateThreadMetadata = (0, import_react2.useCallback)((threadId, updates) => {
    setThreadMetadata((prev) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ThreadContext.Provider, { value, children });
}
...
function AomiRuntimeProvider({
  ...
  const pendingSystemMessagesRef = (0, import_react3.useRef)(/* @__PURE__ */ new Map());
  const pendingChatMessagesRef = (0, import_react3.useRef)(/* @__PURE__ */ new Map());
  const creatingThreadIdRef = (0, import_react3.useRef)(null);
  const createThreadPromiseRef = (0, import_react3.useRef)(null);
  ...
  const currentThreadIdRef = (0, import_react3.useRef)(currentThreadId);
  (0, import_react3.useEffect)(() => {
    currentThreadIdRef.current = currentThreadId;
  }, [currentThreadId]);
  const skipInitialFetchRef = (0, import_react3.useRef)(/* @__PURE__ */ new Set());
  const tempToBackendIdRef = (0, import_react3.useRef)(/* @__PURE__ */ new Map());
  const resolveThreadId = (0, import_react3.useCallback)((threadId) => {
    return tempToBackendIdRef.current.get(threadId) || threadId;
  }, []);
  const findTempIdForBackendId = (0, import_react3.useCallback)((backendId) => {
    for (const [tempId, bId] of tempToBackendIdRef.current.entries()) {
      if (bId === backendId) return tempId;
    }
    return void 0;
  }, []);
  const isThreadReady = (0, import_react3.useCallback)((threadId) => {
    if (!isTempThreadId(threadId)) return true;
    return tempToBackendIdRef.current.has(threadId);
  }, []);
  const applyMessages = (0, import_react3.useCallback)(
    (msgs) => {
      var _a, _b;
      if (!msgs) return;
  ...
  const { startPolling, stopPolling } = (0, import_react3.useMemo)(
  ...
  const threadListAdapter = (0, import_react3.useMemo)(
  ...
  const runtime = (0, import_react4.useExternalStoreRuntime)({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(RuntimeActionsProvider, { value: { sendSystemMessage }, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_react4.AssistantRuntimeProvider, { runtime, children }) });
}
