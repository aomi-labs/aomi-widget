// =============================================================================
// pending_tx — list staged wallet requests for the current Aomi user.
// =============================================================================
//
...
//
// Claude calls this between turns or after `chat` returns
// `newly_queued` ids — to surface details (amounts, descriptions) to the
// user before prompting them to sign via the future `sign_tx` tool.
