...
| `--payment-method` | `AOMI_PAYMENT_METHOD` | —                      | `auto`, `null`, `byok`, `mpp`/`tempo`, `x402`/`coinbase` |
...
# Force x402/Coinbase payment even when the backend also supports Tempo
npx @aomi-labs/client chat "hello" --payment-method x402
