...
type EmbeddedCredentialProvider = () => Promise<{
    provider: "para" | "privy";
...
type AccountBearerProviderOptions = {
    baseUrl: string;
    getEmbeddedCredential: EmbeddedCredentialProvider;
    fetch?: typeof fetch;
    now?: () => number;
