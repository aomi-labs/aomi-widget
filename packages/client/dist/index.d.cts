...
type WalletTxAAMode = "4337" | "7702" | "none";
type WalletTxDebugTraceEntry = {
    layer: string;
    step: string;
    status: "started" | "resolved" | "skipped" | "failed" | "fallback" | "terminal";
    mode?: WalletTxAAMode;
    provider?: string;
    executionKind?: string;
    sponsored?: boolean;
...
declare class ClientSession extends TypedEventEmitter<SessionEventMap> {
     ...
     */
    reject(requestId: string, reason?: string | WalletTxFailureMetadata): Promise<void>;
    /**
...
declare function appendFeeCallToPayload(payload: WalletTxPayload, fee: AomiSimulateFee, defaultChainId: number): WalletTxPayload;
