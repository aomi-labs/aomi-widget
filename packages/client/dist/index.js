...
async function authorizationChallenge(post, request) {
  return post("/api/account/authorization/challenge", request);
}
async function authorizationCommit(post, request) {
...
async function ensureSvmWalletBound(client, wallet, signMessage) {
...
async function createAlchemyWalletApisState(params) {
  ...
  const signer = captureSigner(privateKeyToAccount3(params.privateKey), {
