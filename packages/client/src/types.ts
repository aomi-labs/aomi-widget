...
export function getUserStateSmartAccount4337(
  userState?: UserState | null,
): string | null | undefined {
  return UserState.SmartAccount4337(userState);
}

export function getUserStateDelegation7702(
  userState?: UserState | null,
): string | null | undefined {
...
export function getUserStateWalletProvider(
  userState?: UserState | null,
): UserStateWalletProvider | null | undefined {
  return UserState.walletProvider(userState);
}

export function getUserStateAuthMethod(
  userState?: UserState | null,
): UserStateAuthMethod | null | undefined {
  return UserState.authMethod(userState);
}

export function getUserStateSponsored(
  userState?: UserState | null,
): boolean | null | undefined {
  return UserState.sponsored(userState);
}

export function getUserStateSponsorProvider(
  userState?: UserState | null,
): UserStateSponsorProvider | null | undefined {
  return UserState.sponsorProvider(userState);
}

export function getUserStateSponsorAccount(
  userState?: UserState | null,
): string | null | undefined {
